...
list_of_files = [
    ...
    "research/03_base_model_preparation.ipynb",
    "research/04_model_training.ipynb",
    "research/05_model_evaluation.ipynb",
    "research/06_prediction.ipynb",
